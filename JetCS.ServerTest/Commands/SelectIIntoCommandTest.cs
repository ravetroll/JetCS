...
{
    [TestClass]
    public class SelectIntoCommandTest
    {
        ...
        public void NonExistentDatabaseTest()
        {
            ...
            var result = cli.SendCommand("INSERT INTO TABLE1 (field1,field2) SELECT 'value',1");
            result = cli.SendCommand("SELECT field1, field2 INTO TABLE2 FROM TABLE1");
            Assert.AreEqual("SELECT INTO", result.CommandName);
