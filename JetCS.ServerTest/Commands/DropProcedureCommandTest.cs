...
{
    [TestClass]
    public class DropProcedureCommandTest
    {
        ...
        public void NonExistentDatabaseTest()
        {
            ...
            var result = cli.SendCommand("DROP PROCEDURE Test SELECT 10");
            Assert.AreEqual("DROP PROCEDURE", result.CommandName);
        ...
        public void CorrectLoginPasswordTest()
        {
            ...
            result = cli.SendCommand("DROP PROCEDURE Test");
            Assert.AreEqual("DROP PROCEDURE", result.CommandName);
